  ...
  return (
    <section className="flex flex-col bg-gradient-to-r from-blue-100 to-blue-300 dark:from-gray-800 dark:to-gray-900 font-sans">
      ...
      <p className="max-w-4xl m-auto text-base md:text-lg text-center mb-10 p-4 text-black dark:text-gray-300">
        ...
        <strong className="font-bold text-green-600">MARMO</strong>, é uma
        pessoa coletiva de direito privado, sem fins lucrativos, dotada de
        personalidade jurídica, autonomia administrativa, financeira e
        patrimonial com a sede na cidade de Quelimane, na província da Zambézia
        e delegações em todo o país.
      </p>
      ...
      <section className="bg-green-100 dark:bg-gray-900 py-10 px-6 text-center">
        ...
        >
          ...
          <p className="text-lg text-gray-800 dark:text-green-100 leading-relaxed">
            A <strong className="text-green-600">MARMO</strong> foi criado com
            objectivo primordial de promover a manutenção da diversidade
            biológica, considerada em termos genéticos pacíficos e
            ecossistemáticos, do mar moçambicano.
          </p>
        </motion.div>
      </section>
      ...
      <section className="bg-blue-950 text-white w-full py-13 px-6 text-center">
        ...
        >
          ...
          <p className="text-lg text-blue-100 mb-6">
            Se você ama o mar, acredita na força da comunidade e quer fazer
            parte da transformação ambiental em Moçambique, junte-se à nossa
            rede de voluntários.
          </p>
          <Link to={"/volunteer"}>
            <Button className="bg-green-600 hover:bg-green-600 transition px-6 py-3 rounded text-white font-semibold">
